...
void func_param_syntax::accept(syntax_tree_visitor &visitor) { visitor.visit(*this); }
void bcr_stmt_syntax::accept(syntax_tree_visitor &visitor) { visitor.visit(*this); }
void func_call_syntax::accept(syntax_tree_visitor &visitor) { visitor.visit(*this); }